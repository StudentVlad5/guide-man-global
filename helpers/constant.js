...
export const patternInput = {
  ...
  deadDeathDay: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  deadBirthday: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  ...
  "date.start": /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  "date.end": /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  abroadPassnum: /^[A-Z0-9]{3,30}$/,
  pmjNum: /^[A-Z0-9]{3,30}$/,
  coupleBirthday1: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  coupleBirthday2: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  dateResidence: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
  placeResidence: /^[\w\s,.'\-\u00C0-\u024F\u0400-\u04FF]{5,100}$/,
  eventDate: /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-\d{4}$/,
...
export const inputTypes = {
  ...
  abroadPassnum: "text",
  pmjNum: "text",
  coupleBirthday1: "text",
  coupleBirthday2: "text",
  dateResidence: "text",
  placeResidence: "text",
  eventDate: "text",
  eventTime: "time",
