    ...
    <form className={styles.form}>
      <div className={styles.form__buttons}>
        ...
        <Link
          href="/registration"
          className={clsx([styles.form__toggle__button], {
            [styles.form__toggle__button__active]:
        ...
        {isRegistration && (
          <div className={styles.form__inputContainer}>
            <input
              ...
              className={clsx({
                ...
                [styles.form__input__danger]:
                  validError.phoneNumber || phoneNumberValidError,
              })}
            ...
            {validError.phoneNumber && (
              <div className={styles.form__validError}>
                {t('validForm.fillField')}
              </div>
            )}
            {phoneNumberValidError && (
              <div className={styles.form__validError}>
                {t('validForm.phoneNomber')}
              </div>
            )}
          </div>
        )}
        ...
        <div className={styles.form__inputContainer}>
          <input
            ...
            className={clsx({
              ...
              [styles.form__input__danger]:
                validError.password || passwordValidError,
            })}
      ...
      <button
        ...
        disabled={
          Object.values(validError).some(el => el) ||
          passwordValidError ||
          phoneNumberValidError ||
          emailValidError
        }
