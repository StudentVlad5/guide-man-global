      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.text}>
            Я, громадянин {buildDataString()}, відповідно до Закону Україні «Про
            захист персональних даних», надаю згоду адвокату Строгому Валерію
            Федоровичу на отримання від будь-яких органів державної влади
            України або місцевого самоврядування, підприємств, установ,
